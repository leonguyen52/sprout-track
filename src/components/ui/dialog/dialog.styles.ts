export const dialogStyles = {
  ...
  content: "fixed left-[50%] top-[50%] z-[101] grid w-[95vw] max-w-[1600px] translate-x-[-50%] translate-y-[-50%] gap-4 bg-white/95 backdrop-blur-sm px-4 py-6 sm:p-6 shadow-xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-2xl border border-slate-200 max-h-[90vh] overflow-auto",
