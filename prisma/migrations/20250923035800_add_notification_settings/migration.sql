...
CREATE TABLE "new_Settings" (
    ...
    "defaultBottleUnit" TEXT NOT NULL DEFAULT 'ML',
    "defaultSolidsUnit" TEXT NOT NULL DEFAULT 'TBSP',
    "defaultHeightUnit" TEXT NOT NULL DEFAULT 'CM',
    "defaultWeightUnit" TEXT NOT NULL DEFAULT 'KG',
    "defaultTempUnit" TEXT NOT NULL DEFAULT 'C',
    ...
    "notificationFeedAdvanceMinutes" INTEGER NOT NULL DEFAULT 0,
    "notificationDiaperAdvanceMinutes" INTEGER NOT NULL DEFAULT 0,
