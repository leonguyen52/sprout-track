...
INSERT INTO "new_Account" ("caretakerId", "createdAt", "email", "familyId", "firstName", "id", "lastName", "password", "passwordResetExpires", "passwordResetToken", "planExpires", "planType", "provider", "providerId", "stripeCustomerId", "subscriptionId", "trialEnds", "updatedAt", "verificationToken", "verified") SELECT "caretakerId", "createdAt", "email", "familyId", "firstName", "id", "lastName", "password", "passwordResetExpires", "passwordResetToken", "planExpires", "planType", "provider", "providerId", "stripeCustomerId", "subscriptionId", "trialEnds", "updatedAt", "verificationToken", "verified" FROM "Account";
DROP TABLE "Account";
